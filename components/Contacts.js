                        ...
                        <li className="nav-item">
                            <div className="contacts-item position-relative d-inline-flex align-items-center px-0 px-lg-5 py-3 py-lg-0">
                                ...
                                <div>
                                    ...
                                    <span className="small text-muted">+62 123 456 7890</span>
                                </div>
                            </div>
                        </li>
                        <li className="nav-item">
                            <div className="contacts-item position-relative d-inline-flex align-items-center px-0 px-lg-5 py-3 py-lg-0">
                                ...
                                <div>
                                    ...
                                    <span className="small text-muted">mail@djanoerkuning.com</span>
                                </div>
                            </div>
                        </li>
                        <li className="nav-item">
                            <div className="contacts-item position-relative d-inline-flex align-items-center px-0 px-lg-5 py-3 py-lg-0">
                                ...
                                <div>
                                    ...
                                    <span className="small text-muted">@djanoer.kuning</span>
                                </div>
                            </div>
                        </li>
                    </ul>
