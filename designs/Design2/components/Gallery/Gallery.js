                    ...
                    <div className="col-lg-7">
                        <div className="position-relative">
                            ...
                            <div className="slider-arrow position-absolute top-50 left-0 y-min-50 d-none d-lg-flex w-100 px-5">
                                <button className="btn btn-mask-dark circle rounded-right-2 shadow-sm" onClick={() => slider.slickPrev()}>
                                    <i className="fa fa-chevron-left x-min-1-y-1" />
                                </button>
                                <button className="btn btn-mask-dark circle ml-auto rounded-left-2 shadow-sm" onClick={() => slider.slickNext()}>
