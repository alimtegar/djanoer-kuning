...
const Hero = ({ backgroundImage, groomNickname, brideNickname, weddingDate }) => (
    ...
    >
        <div className="position-relative text-white text-center p-5 p-lg-6 mask-dark rounded-xl">
            <div className="position-absolute top-0 left-50 x-min-50-y-min-50 circle circle-lg bg-dark shadow-sm">
                <img src="/assets/images/ring.svg" alt="" className="" height="55" style={{ marginTop: -4, }} />
            </div>
